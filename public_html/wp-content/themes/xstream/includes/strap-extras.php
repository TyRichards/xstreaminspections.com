...
function bootstrap_styles()
{
	...
	wp_register_style( 'bootstrap-styles', get_template_directory_uri() .'/admin/layouts/' . bi_get_data('bootswatch'), array(), '3.1.0', 'all' );
    ...
    wp_register_style( 'responsive-style', get_stylesheet_uri(), false, '3.1.0' );
