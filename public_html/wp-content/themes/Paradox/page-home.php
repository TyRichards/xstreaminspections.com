        ...
        <div class="col-sm-7"> 
            <div class="flex-video widescreen">
                <a href="#">
                    ...
                    <img class="player" src="<?php echo get_template_directory_uri(); ?>/assets/images/video-placeholder.jpg" alt="Xstream Inspections Commercial & Residential Inspections" width="100%" height="100%">
                </a>                    
            </div>
        </div>
        <div class="col-sm-5">
